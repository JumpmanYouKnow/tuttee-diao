System.register([], function(exports_1, context_1) {
    ...
    var comment1, comment2, TUTPROFILES;
    return {
        setters:[],
        execute: function() {
            comment1 = { course: "math135", faculty: "math1A", time: new Date(43214321412), content: "fuckthisshit" };
            comment2 = { course: "math136", faculty: "SE1B", time: new Date(21324324), content: "你是傻逼" };
